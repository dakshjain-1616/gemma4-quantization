...
from quantization import (
    Quantizer, QuantizationLevel,
    apply_quantization_to_model, apply_quantization_to_layer,
...
def run_benchmark_evaluation():
    ...
    for level in quantization_levels:
        ...
        # Deep copy so each level starts from the unmodified FP16 model
        from copy import deepcopy
        quantizer = Quantizer(level)
        quantized_model = apply_quantization_to_model(deepcopy(model), quantizer)
